                ...
                <!-- Logo -->
                 <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="https://logos-world.net/wp-content/uploads/2021/08/Booking-Symbol.png" alt="Logo" width="80" height="40">
                    </a>
                </div>
                            ...
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                    @if(!empty(auth()->user()->profile_photo_path))
                                        <img src="{{ asset('storage/'.auth()->user()->profile_photo_path) }}" alt="{{ auth()->user()->name }}" class="rounded-full h-8 w-8 round-full object-cover">
                                    @else
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <x-jet-dropdown-link href="{{ route('logout') }}"
                                         @click.prevent="$root.submit();"  style="text-decoration: none;">
                                    {{ __('Log Out') }}
                                </x-jet-dropdown-link>
                            </form>
                        </x-slot>
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <x-jet-responsive-nav-link href="{{ route('logout') }}"
                                   @click.prevent="$root.submit();" class="no-underline">
                        {{ __('Log Out') }}
                    </x-jet-responsive-nav-link>
                </form>
