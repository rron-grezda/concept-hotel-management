        ...
        <div class="container my-5">
                ...
                <div class="d-flex justify-content-end align-items-center gap-2">
                    ...
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                            <li><a class="dropdown-item" href="{{ route('set-locale', 'sq') }}">Shqip</a></li>
                            <li><a class="dropdown-item" href="{{ route('set-locale', 'en') }}">English</a></li>
                            <li><a class="dropdown-item" href="{{ route('set-locale', 'fi') }}">Suomi</a></li>
                        </ul>
                    </div>
            ...
            <div class="p-5 mt-5">
                <div class="container">
                    ...
                    @endif
                    <h1 class="fw-bold" style="color: #21130d; text-align: center;">{{ __('messages.welcome') }}</h1>
                    <br>
                    <h2 class="text-center mb-4 fw-bold" style="color: #21130d;">{{ __('messages.search_hotels') }}</h2>
                    <form action="/search" class="d-flex align-items-center justify-content-between gap-3">
                        <div class="form-group w-50">
